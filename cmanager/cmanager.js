      ...
      if (arr_tokens.length >0 ){
        if (activetokenid !== undefined) {
          ...
          // console.log(api_credential1);
           ...
           list_html1 += '<a id="sidenavbutton" class="btn blue-grey lighten-5 hoverable blue-grey-text text-darken-3 center-align">Switch Akamai API credentials</a>';
           list_html1 += '</div>';
       ...
       // list_html2 += '<i class="material-icons key-img circle teal lighten-2 z-depth-1" style="display: none;">lock_open</i>';
        list_html2 += '<p class="center-align blue-grey-text"><b>Congrats on adding your first Akamai API credential!</b> You need to activate the credential in order to use it across the extension </p>';
        list_html2 += '<p class="center-align"><a id="sidenavbutton" class="btn light-blue hoverable white-text center-align activate_token_creds">Activate Akamai API credentials</a></p>';
        list_html2 += '</li>';
